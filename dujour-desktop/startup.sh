...
osascript -e 'tell app "Terminal" to do script "cd /Users/samblack/Desktop/MERN/Projects/fleetware/dujour-desktop/client && npm start"'

# Start Node.js server in a new Terminal window, ensuring the path is correct for where your server code resides.
osascript -e 'tell app "Terminal" to do script "cd /Users/samblack/Desktop/MERN/Projects/fleetware/dujour-desktop/server && node server.js"'
