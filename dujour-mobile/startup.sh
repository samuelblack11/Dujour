...
osascript -e 'tell app "Terminal" to do script "cd /Users/samblack/Desktop/MERN/Projects/dujour/dujour-mobile/client && npm start"'

# Start Node.js server in a new Terminal window, ensuring the path is correct for where your server code resides.
osascript -e 'tell app "Terminal" to do script "cd /Users/samblack/Desktop/MERN/Projects/dujour/dujour-mobile/server && node server.js"'

# Open a Terminal window for Git operations, ensuring the path directs to the root of your project.
osascript -e 'tell app "Terminal" to do script "cd /Users/samblack/Desktop/MERN/Projects/dujour && git status"'
